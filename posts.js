...
cursor.execute('SELECT * FROM users WHERE username = %s', (username,))</code></pre>
    ...
    'react-hooks': {
        title: 'Building Custom React Hooks for Complex State',
        date: '2026-01-01',
        readTime: '6min',
        tags: ['react', 'javascript', 'tutorial'],
        description: 'Learn how to create reusable React hooks for managing complex application state',
        content: `
            <h1 class="single-title">Building Custom React Hooks for Complex State</h1>
            <div class="metadata">
                2026-01-05 | <i data-feather="clock" style="width:14px;height:14px"></i> 6min
                <div class="post-tags tags">
                    <a href="tags.html?tag=react">react</a>
                    <a href="tags.html?tag=javascript">javascript</a>
                    <a href="tags.html?tag=tutorial">tutorial</a>
                </div>
            </div>

            <h2>Introduction</h2>
            <p>React Hooks have revolutionized how we manage state and side effects in functional components. Custom hooks allow us to extract and reuse stateful logic across multiple components. In this tutorial, we'll build custom hooks for complex state management scenarios.</p>

            <h2>Understanding Custom Hooks</h2>
            <p>A custom hook is simply a JavaScript function whose name starts with "use" and that may call other hooks. This allows you to extract component logic into reusable functions.</p>

            <h3>Basic Custom Hook Example</h3>
  ...
  return { count, increment, decrement, reset };
            ...
            <p>For complex state, we can combine multiple hooks and create more sophisticated patterns.</p>

            <h3>useReducer for Complex State</h3>
            <pre><code>function useComplexState(initialState) {
  ...
  return { state, setField, reset };
            ...
            <h2>Real-World Example: Form Management</h2>
            <p>Let's build a custom hook for managing form state with validation:</p>
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <button type="submit">Login</button>
            ...
            <ul>
                <li><strong>Start with "use":</strong> Always name custom hooks starting with "use" for React's linting rules</li>
                <li><strong>Keep hooks pure:</strong> Don't mutate state directly, always return new values</li>
                <li><strong>Composition over complexity:</strong> Build small, focused hooks that do one thing well</li>
                <li><strong>Dependencies matter:</strong> Be careful with useEffect dependencies to avoid infinite loops</li>
            </ul>

            <h2>Conclusion</h2>
            <p>Custom hooks are a powerful pattern for sharing stateful logic between components. By extracting complex state management into reusable hooks, you can keep your components clean and focused on rendering UI.</p>
        `
    },
    'csrf-explained': {
